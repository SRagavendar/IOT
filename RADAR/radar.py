...
### Arduino must send angle;distance
### Example: 180;10 ( 180 is the angle and 10 is te distance in CM)

ser=serial.Serial()
ser.timeout=1
ser.port='/dev/cu.usbmodem1421' # port name where the arduino 
ser.open()
green=(0,255,0)
point_list=[]
...
def draw_point(list_point,disp=disp):
    for point in list_point:
        pygame.draw.circle(disp,green,point,5)
